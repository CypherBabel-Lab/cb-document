...
## V1.7.5 BETA ( 29 Jul 2023)

### Features

* Added dual-language support for all the notice modals.
* Added icon for all the token assets.
* Added sUSDT claim feature.

### Optimizations

* Optimized the login process.
* Optimized UI\&UE of swap.

### Bugs Fixed

* Fixed the issue that the side menu does fold after clicking.
* Fixed the issue of not displaying the wallet option that occurred in cellphone mode.
* Fixed the login error that occurred in cellphone mode.
* Fixed the error of the locale button in cellphone mode.&#x20;
* Fixed the data error in the index line chart.
* Fixed the error logic of the search feature.
