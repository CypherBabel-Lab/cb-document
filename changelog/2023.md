...
* Add a leaderboard page with five different tracks.
* Add a countdown for the faucet button.
* Add a notification page.
* Add a "mine" tag to the fund card so that the fund creators can recognize their created funds instantly.
...
* Optimized the display of fund names when too long in the dropdown of the search bar.
