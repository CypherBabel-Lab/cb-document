...
* Add a smart contract for constraint configuration.
* Add a smart contract for fund fees.
* Add a smart contract for price feed.
* Add off-chain data calculation for various fund data.
* Add a smart contract for fund creation.
* Add a smart contract for fund interaction.
* Add a smart contract for the core logic of the on-chain fund.
* Add a fund creation simulation feature.
...
* Add a smart contract for copy-investing.
* Add a quick selection with percentile options for the simulated fund investing.

### Optimizations

* Domain migration.
* Default routing optimization.
* Optimize the data precision for the fund share price.
